#SAW x 404 tools fb   intsgram 127.0.0
...
def banner():
	...
	\033[1;34m  >=>>=>   >=>         >=>     >=>>=>           >=>>=>
			...
			\033[1;31m[ Github : SAW4x ]
			\033[1;37m[ TELEGRAM : @SAWx404 ]
			\033[1;34m[ instagram : 127.0.0 ]
""")
# VALIDASI TOKEN
def login():
		try:
...
def login_lagi334():
	try:
		...
		print('\n LOGIN  python SAWx1234.py ');time.sleep(1)
		exit()
	except Exception as e:
		os.system("rm -f .token.txt")
		os.system("rm -f .cok.txt")
		print('%s# COOKIES / CP  '%(h))
		exit()
# MENU
...
def menu(my_name,my_id):
	...
	sol().print(fx)
	io = ' [01] CLONE ID PUBLIC \n [02] CLONE ID PUBLIC (MULTI) \n [03] CLONE SAW HACK ACCOUNT FB \n [04] CLONE FILE \n [0] LOGOUT'
	print(f"\033[1;37m			[IP] = \033[1;37m  {ip} ")
	print(f"\033[1;37m			[Region] = %s "%gep['region'])
	print("")
	oi = nel(io, style='bold green')
	cetak(nel(oi, title='SAW-404'))
	jh = input(x+''+p+''+x+' CHOICE : ')
	if jh in ['1','01']:
		dump_publik()
	elif jh in ['2','02']:
		dump_massal()
